...
void main()
{
    ...
    if (aNormal == vec3( 0.0,  0.0,-1.0)) fColor = colors[1];
    if (aNormal == vec3( 0.0,  1.0, 0.0)) fColor = colors[2];
    if (aNormal == vec3( 0.0, -1.0, 0.0)) fColor = colors[3];
    if (aNormal == vec3( 1.0,  0.0, 0.0)) fColor = colors[4];
    if (aNormal == vec3(-1.0,  0.0, 0.0)) fColor = colors[5];
    alpha = 1.0;
